...
**YOU ARE IN: `gastest/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gastest/` (rig root) or other directories
...
**Your mail address:** `gastest/polecats/rust`
**Your rig:** gastest
**Your Witness:** `gastest/witness`
...
| Ask Witness for help | `gt mail send gastest/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gastest/witness`) when:
...
```bash
gt mail send gastest/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
